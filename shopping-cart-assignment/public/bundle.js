...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__CarouselComponent__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__BillingComponent__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__itemComponent__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__service_dataLayer__ = __webpack_require__(0);
...
class ShoppingCartComponent{
    constructor(parent){
        this.parent=parent;
        this.shoppingCartService=new __WEBPACK_IMPORTED_MODULE_3__service_dataLayer__["a" /* default */]();
    ...
    render() {
        this.shoppingCartService.getDataShoppingCart().then((result)=>{
            ...
            result.forEach(item => {
                ...
                new __WEBPACK_IMPORTED_MODULE_2__itemComponent__["a" /* default */]('#itemsDiv', item);
                doBilling.call(this,item);

            });
            new __WEBPACK_IMPORTED_MODULE_1__BillingComponent__["a" /* default */]('#paymentandhelp',this.billingAmount);
           
            new __WEBPACK_IMPORTED_MODULE_0__CarouselComponent__["a" /* default */]('#carousel');
        });  
...
class CarouselComponent{
    ...
    render(){
        ...
        <p class="carouselHead">TAKE A LOOK AT OUR NEW ARRIVALS</p>
                            ...
                            <section class="description">
                                      ...
                                      <section class="rightItem">
                                            ...
                                            <div class="qty"> 
                                              ...
                                              <input type="text" value=${this.quantity} disabled class="textbox"/>
                                            </div>
                                            <div class="amount">
